...
const categories = [
  {
    slug: "auto-algemeen",
    naam: "🚗 BMW Auto's – Algemeen",
    beschrijving: "Algemene discussies over BMW auto's die niet in een specifieke serie passen.",
    type: "algemeen",
    volgorde: 0,
    subforums: [
  ...
  },
  {
    slug: "serie-1",
    naam: "BMW 1 Serie",
    beschrijving: "E87, E81, F20, F40 — alles over de BMW 1 Serie hatchback.",
    type: "auto",
    volgorde: 1,
    subforums: [
  ...
  },
  {
    slug: "serie-2",
    naam: "BMW 2 Serie",
    beschrijving: "F22, F45, G42 — Coupé, Active Tourer en Gran Coupé.",
    type: "auto",
    volgorde: 2,
    subforums: [
  ...
  },
  {
    slug: "serie-3",
    naam: "BMW 3 Serie",
    beschrijving: "E30, E36, E46, E90, F30, G20 — het hart van BMW.",
    type: "auto",
    volgorde: 3,
    subforums: [
      { slug: "3-serie-techniek", naam: "Techniek & Onderhoud", beschrijving: "Motorproblemen, ketting, beurten.", volgorde: 0 },
      { slug: "3-serie-aankoop", naam: "Aankoop & Occasions", beschrijving: "Welke 3 Serie kopen? Controleer dit.", volgorde: 1 },
  ...
  },
  {
    slug: "serie-4",
    naam: "BMW 4 Serie",
    beschrijving: "F32, F82, G22 — Coupé, Cabrio en Gran Coupé.",
    type: "auto",
    volgorde: 4,
    subforums: [
  ...
  },
  {
    slug: "serie-5",
    naam: "BMW 5 Serie",
    beschrijving: "E34, E39, E60, F10, G30 — de zakelijke BMW bij uitstek.",
    type: "auto",
    volgorde: 5,
    subforums: [
  ...
  },
  {
    slug: "serie-6",
    naam: "BMW 6 Serie",
    beschrijving: "E63, F12, G32 Gran Turismo — elegant en krachtig.",
    type: "auto",
    volgorde: 6,
    subforums: [
  ...
  },
  {
    slug: "serie-7",
    naam: "BMW 7 Serie",
    beschrijving: "E38, E65, F01, G11 — de luxe limousine van BMW.",
    type: "auto",
    volgorde: 7,
    subforums: [
  ...
  },
  {
    slug: "serie-8",
    naam: "BMW 8 Serie",
    beschrijving: "E31, G14/G15 — de grand tourer van BMW.",
    type: "auto",
    volgorde: 8,
    subforums: [
  ...
  {
    slug: "x-serie",
    naam: "BMW X Serie (SUV's)",
    beschrijving: "X1 t/m X7 — BMW's SUV-familie.",
    type: "auto",
    volgorde: 9,
    subforums: [
  ...
  {
    slug: "m-serie-auto",
    naam: "BMW M Serie (Auto's)",
    beschrijving: "M2, M3, M4, M5, M8, XM — pure M-modellen.",
    type: "auto",
    volgorde: 10,
    subforums: [
  ...
  {
    slug: "i-serie",
    naam: "BMW i Serie (Elektrisch)",
    beschrijving: "i3, i4, i5, i7, iX — elektrische BMW's.",
    type: "auto",
    volgorde: 11,
    subforums: [
  ...
  {
    slug: "z-serie",
    naam: "BMW Z Serie & Roadsters",
    beschrijving: "Z3, Z4, Z8 — open rijplezier.",
    type: "auto",
    volgorde: 12,
    subforums: [
  ...
  {
    slug: "motor-algemeen",
    naam: "🏍️ BMW Motorrad – Algemeen",
    beschrijving: "Algemene discussies over BMW motorfietsen.",
    type: "algemeen",
    volgorde: 20,
    subforums: [
  ...
  },
  {
    slug: "gs-serie-motor",
    naam: "BMW GS Serie",
    beschrijving: "R 1300 GS, R 1250 GS, R 1200 GS, F 900 GS, G 310 GS — de avonturiers.",
    type: "motor",
    volgorde: 21,
    subforums: [
      ...
      { slug: "f900gs-forum", naam: "F 900 GS & Adventure", beschrijving: "De middelgrote GS — ideaal voor beginners.", volgorde: 3 },
  ...
  {
    slug: "s-serie-motor",
    naam: "BMW S & M Serie (Sport)",
    beschrijving: "S 1000 RR, M 1000 RR, S 1000 R, M 1000 R, S 1000 XR.",
    type: "motor",
    volgorde: 22,
    subforums: [
  ...
  {
    slug: "r-serie-motor",
    naam: "BMW R Serie & Heritage",
    beschrijving: "R 18, R nineT, R 1250 RT — boxer-twins en cruisers.",
    type: "motor",
    volgorde: 23,
    subforums: [
  ...
  {
    slug: "k-serie-motor",
    naam: "BMW K Serie (Tourers)",
    beschrijving: "K 1600 GT, K 1600 GTL — zescilinder tourers.",
    type: "motor",
    volgorde: 24,
    subforums: [
  ...
  {
    slug: "f-g-serie-motor",
    naam: "BMW F & G Serie",
    beschrijving: "F 900 R, F 900 XR, G 310 R — middenklasse en instap.",
    type: "motor",
    volgorde: 25,
    subforums: [
  ...
  {
    slug: "ce-serie-motor",
    naam: "BMW CE Elektrisch",
    beschrijving: "CE 04 en toekomstige elektrische Motorrad modellen.",
    type: "motor",
    volgorde: 26,
    subforums: [
...
async function main() {
  ...
  for (const cat of categories) {
    const { subforums: subs, ...catData } = cat;
