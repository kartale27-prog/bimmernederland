      ...
      <section style={{ background: "linear-gradient(135deg, #0a0a0a, #0d1b3e)", padding: "4rem 1.5rem 3rem" }}>
        <div style={{ maxWidth: "800px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "1.25rem" }}>
            <div style={{ width: "60px", height: "60px", borderRadius: "50%", background: `hsl(${user.username.charCodeAt(0) * 15}, 60%, 35%)`, display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 900, fontSize: "1.5rem", color: "white", flexShrink: 0 }}>
